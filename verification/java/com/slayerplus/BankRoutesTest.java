...
public class BankRoutesTest {
  ...
  @Test
  public void usedCraftingBankBeatsFaladorAndSurvivesReload() {
  ...
  @Test
  public void adjacentBankVisitsDoNotSaveAgainButDifferentFloorsDo() {
    BankRoutes routes = new BankRoutes();
    routes.useProfile("account-a", () -> null);
    assertTrue(routes.remember(crafting, false));
  ...
  @Test
  public void profilesStaySeparateAndAreLoadedOnlyOnChange() {
    BankRoutes routes = new BankRoutes();
    ...
    routes.useProfile(
        "account-a",
        () -> {
          throw new AssertionError("Repeated config read");
        });
    ...
    routes.useProfile(
        null,
        () -> {
          throw new AssertionError("Anonymous config read");
        });
  ...
  @Test
  public void rejectsInstancedInvalidAndCorruptLocations() {
    BankRoutes routes = new BankRoutes();
  ...
  @Test
  public void unrestrictedBanksWorkWithoutHistory() {
    BankRoutes routes = new BankRoutes();
    for (WorldPoint bank :
        new WorldPoint[] {
          new WorldPoint(2443, 3083, 0),
          new WorldPoint(2536, 3573, 0),
          new WorldPoint(3427, 2891, 0),
          new WorldPoint(3308, 3120, 0)
        }) {
  ...
  @Test
  public void savingDiscoveredBankDoesNotScheduleLoadoutWork() {
