...
public class SlayerRoutePlanRuntimeRegressionTest
{
	...
	public void loadedEntranceKeepsRoutingUntilPlayerReachesApproachRadius()
	{
		...
		final SlayerRoutePlan.RouteTarget target =
			SlayerRoutePlan.RouteTarget.point("Reviewed cave entrance", entrance, 4);
	...
	{
		final SlayerRoutePlan.RouteTarget instruction =
			SlayerRoutePlan.RouteTarget.instruction("Live-state dungeon handoff");
