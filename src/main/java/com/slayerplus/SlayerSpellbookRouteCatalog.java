...
public final class SlayerSpellbookRouteCatalog {
  ...
  private static final Route ANCIENT_ROUTE =
      new Route(
          "Ancient Magicks",
          new WorldPoint(3231, 9311, 0),
          "Pray at the altar inside the Ancient Pyramid to switch spellbooks.");
  private static final Route LUNAR_ROUTE =
      new Route(
          "Lunar spellbook",
          new WorldPoint(2156, 3864, 0),
          "Pray at the Astral Altar to switch spellbooks.");
  private static final Route ARCEUUS_ROUTE =
      new Route(
          "Arceuus spellbook",
          new WorldPoint(1714, 3883, 0),
          "Do not use the Dark Altar itself. Talk to Tyss beside it and ask to activate the Arceuus"
              + " spellbook.");
  private static final Route STANDARD_FROM_ARCEUUS_ROUTE =
      new Route(
          "Standard spellbook",
          new WorldPoint(1714, 3883, 0),
          "Do not use the Dark Altar itself. Talk to Tyss beside it and ask him to lift the Arceuus"
              + " spellbook.");

  private SlayerSpellbookRouteCatalog() {}

  public static Route resolve(String requiredSpellbook, int currentSpellbook) {
    String required = normalize(requiredSpellbook);
    ...
    if (required.contains("standard")) {
      switch (currentSpellbook) {
        case ANCIENT:
          return ANCIENT_ROUTE;
        case LUNAR:
          return LUNAR_ROUTE;
        case ARCEUUS:
          return STANDARD_FROM_ARCEUUS_ROUTE;
        case STANDARD:
        default:
          return null;
      }
  ...
  public static final class Route {
    ...
    private Route(String spellbookName, WorldPoint destination, String interaction) {
    ...
    public Set<WorldPoint> getTargets() {
      return RouteCatalog.targetArea(destination, 2);
    }
  }
}
