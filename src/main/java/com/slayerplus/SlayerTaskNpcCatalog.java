...
public final class SlayerTaskNpcCatalog {
  ...
  public static Set<String> aliasesFor(String assignment) {
  ...
  public static Set<String> aliasesForStandardRoute(String assignment) {
    Set<String> aliases = new LinkedHashSet<>(aliasesFor(assignment));
  ...
  private static void putExclusions(
      Map<String, Set<String>> map, String assignment, String... npcNames) {
    ...
    if (previous != null && !previous.equals(immutable)) {
      throw new IllegalStateException(
          "Conflicting duplicate Slayer NPC exclusion entry: " + assignment);
    }
  }

  private static void put(Map<String, Set<String>> map, String assignment, String... npcNames) {
    Set<String> aliases = new LinkedHashSet<>();
    if (npcNames != null) {
      for (String npcName : npcNames) {
    ...
    if (previous != null && !previous.equals(immutable)) {
      throw new IllegalStateException(
          "Conflicting duplicate Slayer NPC alias entry: " + assignment);
    }
  }
