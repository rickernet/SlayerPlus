...
public final class KitItem {
  ...
  public MethodRules.InventoryGroup getInventoryGroup() {
    return inventoryGroup;
  }

  public KitItem asEquipmentSwitch(SwitchStyle style) {
    return new KitItem(
        displayName, itemId, quantity, status, true, style, inventoryGroup);
  }

  public KitItem withInventoryGroup(MethodRules.InventoryGroup group) {
    return new KitItem(
        displayName, itemId, quantity, status, equipmentSwitch, switchStyle, group);
  }
