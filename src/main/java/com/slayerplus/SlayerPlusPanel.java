...
public SlayerPlusPanel(){this(null,null,null,null);
}public SlayerPlusPanel(Runnable bankTagAction,Consumer<TaskVariant>bankVariantAction,SlayerPlusConfig config,ConfigManager configs){this.bankTagAction=bankTagAction;
